...
def ensure_dataset():
    ...
    # Check whether dataset already contains images
    existing_images = [
    ...
    try:
        ...
        # Find dataset_ordered inside downloaded repository
        dataset_source = None
        ...
        # Copy images into local dataset_ordered folder
        ...
        # Remove temporary ZIP/extracted repository
        shutil.rmtree(
            temp_dir,
            ignore_errors=True
        )
